...
@app.route("/api/category-content/<cat_slug>")
def category_content(cat_slug):
    """Exposes the same CAT_SEO/CAT_RELATED editorial content the Jinja
    category page already renders (headline, intro, keywords, FAQ, related
    categories), as JSON, so the Next.js frontend's category PLP can ship
    real FAQ schema instead of inventing content. Read-only, no DB query."""
    cat = next((c for c in CATEGORIES if slugify(c) == cat_slug), None)
    if not cat:
    ...
    resp = jsonify({
        "category": cat,
        "headline": seo.get("headline", f"{cat} Medical Supplies"),
        "intro": seo.get("intro", ""),
        "keywords": seo.get("keywords", []),
        "faq": seo.get("faq", []),
        "related": CAT_RELATED.get(cat, []),
    })
...
# Subcategory-level queries — 278 buckets covering every (category, subcategory)
# pair in the 500k-row catalog. This replaces the old 20-bucket category-only
# scheme so that, e.g., "Stethoscopes" and "Dental Needles" don't share the same
# 8 recycled stock photos as every other product in their parent category —
# each of the ~266 distinct subcategories gets its own targeted photo pool.
# Falls back to PEXELS_QUERIES[cat_slug] for any bucket not listed here.
SUBCAT_PEXELS_QUERIES = {
    'dental/dental': 'dental equipment',
    'dental/dental-needles': 'Dental Needles dental equipment',
    'dental/dental-mirrors': 'Dental Mirrors dental equipment',
    'dental/dental-trays': 'Dental Trays dental equipment',
    'dental/impression-materials': 'Impression Materials dental equipment',
    'dental/suction-tips': 'Suction Tips dental equipment',
    'dental/dental-bibs': 'Dental Bibs dental equipment',
    'diagnostic/ophthalmoscopes': 'Ophthalmoscopes medical diagnostic equipment',
    'diagnostic/stethoscopes': 'Stethoscopes medical diagnostic equipment',
    'diagnostic/otoscopes': 'Otoscopes medical diagnostic equipment',
    'diagnostic/diagnostic': 'medical diagnostic equipment',
    'diagnostic/rapid': 'rapid diagnostic test kit',
    'diagnostic/pulse-oximeters': 'Pulse Oximeters medical diagnostic equipment',
    'diagnostic/sphygmomanometers': 'Sphygmomanometers medical diagnostic equipment',
    'diagnostic/blood-pressure-monitors': 'Blood Pressure Monitors medical diagnostic equipment',
    'diagnostic/thermometers': 'Thermometers medical diagnostic equipment',
    'diagnostic/digital-oral-axillary': 'Digital Oral/Axillary medical diagnostic equipment',
    'diagnostic/no-touch-infrared': 'No-Touch Infrared medical diagnostic equipment',
    'diagnostic/sterile': 'sterile medical diagnostic kit',
    'diagnostic/point-of-care': 'point of care testing medical',
    'diagnostic/disposable': 'disposable medical diagnostic supplies',
    'diagnostic/blood-glucose-meter': 'Blood Glucose Meter medical diagnostic equipment',
    'diagnostic/incentive': 'incentive spirometer',
    'diagnostic/classic': 'stethoscope medical',
    'diagnostic/fingertip': 'fingertip pulse oximeter',
    'diagnostic/taylor': 'reflex hammer medical',
    'diagnostic/hcg-rapid': 'pregnancy test kit medical',
    'diagnostic/safety-lancets-30g': 'safety lancet blood test',
    'diagnostic/group-a': 'strep test kit medical',
    'diagnostic/aneroid': 'aneroid blood pressure monitor',
    'diagnostic/256-hz-c': 'tuning fork medical',
    'diagnostic/digital': 'digital thermometer medical',
    'diagnostic/cardiology': 'cardiology stethoscope',
    'diagnostic/100ct': 'medical test strips box',
    'diagnostic/10-parameter': 'urinalysis test strips',
    'first-aid/first-aid': 'first aid kit',
    'first-aid/antiseptics': 'Antiseptics first aid medical',
    'first-aid/eye-wash': 'Eye Wash first aid medical',
    'first-aid/first-aid-kits': 'First Aid Kits first aid medical',
    'first-aid/burns': 'Burns first aid medical',
    'first-aid/bandages': 'Bandages first aid medical',
    'gloves/exam-gloves': 'Exam Gloves medical exam gloves',
    'gloves/surgical-gloves': 'Surgical Gloves medical exam gloves',
    'gloves/chemotherapy-gloves': 'Chemotherapy Gloves medical exam gloves',
    'iv/iv-catheters': 'IV Catheters IV intravenous medical',
    'iv/vascular': 'vascular access IV medical',
    'iv/injection': 'injection syringe medical',
    'iv/iv-administration': 'IV Administration IV intravenous medical',
    'iv/iv-fluids': 'IV Fluids IV intravenous medical',
    'iv/iv-accessories': 'IV Accessories IV intravenous medical',
    'iv/lab-collection': 'Lab Collection IV intravenous medical',
    'iv/needleless-connector': 'Needleless Connector IV intravenous medical',
    'iv/peripheral': 'peripheral IV catheter',
    'iv/iv-therapy': 'IV Therapy IV intravenous medical',
    'iv/collection': 'blood collection tube medical',
    'iv/central-line': 'Central Line IV intravenous medical',
    'iv/gravity': 'IV gravity infusion set',
    'iv/infusion-pumps': 'Infusion Pumps IV intravenous medical',
    'iv/syringes': 'Syringes IV intravenous medical',
    'iv/needleless-connectors': 'Needleless Connectors IV intravenous medical',
    'iv/iv-tubing': 'IV Tubing IV intravenous medical',
    'iv/blood-collection': 'Blood Collection IV intravenous medical',
    'incontinence/liners': 'Liners adult incontinence care medical',
    'incontinence/adult-briefs': 'Adult Briefs adult incontinence care medical',
    'incontinence/underpads': 'Underpads adult incontinence care medical',
    'incontinence/swim-diapers': 'Swim Diapers adult incontinence care medical',
    'incontinence/underpads-chux': 'Underpads (Chux) adult incontinence care medical',
    'incontinence/adult-briefs-tab-style': 'Adult Briefs (Tab Style) adult incontinence care medical',
    'incontinence/liner-pads': 'Liner Pads adult incontinence care medical',
    'incontinence/belted-undergarments': 'Belted Undergarments adult incontinence care medical',
    'incontinence/protective-underwear': 'Protective Underwear adult incontinence care medical',
    'incontinence/bladder-control-pads': 'Bladder Control Pads adult incontinence care medical',
    'incontinence/male-guards': 'Male Guards adult incontinence care medical',
    'incontinence/fecal-incontinence-pouch': 'Fecal Incontinence Pouch adult incontinence care medical',
    'incontinence/pediatric-diapers': 'Pediatric Diapers adult incontinence care medical',
    'incontinence/guards-shields': 'Guards & Shields adult incontinence care medical',
    'incontinence/pull-ons': 'incontinence pull-on underwear',
    'lab/lab': 'medical laboratory supplies',
    'lab/lab-safety': 'Lab Safety medical laboratory',
    'lab/pipettes': 'Pipettes medical laboratory',
    'lab/microbiology': 'Microbiology medical laboratory',
    'lab/blood-collection': 'Blood Collection medical laboratory',
    'lab/histology': 'Histology medical laboratory',
    'lab/slides-coverslips': 'Slides & Coverslips medical laboratory',
    'lab/reagents': 'Reagents medical laboratory',
    'lab/lab-tubes': 'Lab Tubes medical laboratory',
    'lab/specimen-collection': 'Specimen Collection medical laboratory',
    'lab/phlebotomy': 'Phlebotomy medical laboratory',
    'lab/lab-ppe': 'Lab PPE medical laboratory',
    'lab/collection': 'specimen collection medical',
    'lab/urinalysis': 'Urinalysis medical laboratory',
    'mobility/mobility': 'mobility aid medical',
    'mobility/walkers': 'Walkers mobility wheelchair medical',
    'mobility/crutches': 'Crutches mobility wheelchair medical',
    'mobility/dme': 'durable medical equipment',
    'mobility/wheelchairs': 'Wheelchairs mobility wheelchair medical',
    'mobility/hospital-beds': 'Hospital Beds mobility wheelchair medical',
    'mobility/commodes': 'Commodes mobility wheelchair medical',
    'mobility/canes': 'Canes mobility wheelchair medical',
    'nutrition/enteral-feeding': 'Enteral Feeding medical enteral nutrition',
    'nutrition/oral-supplements': 'Oral Supplements medical enteral nutrition',
    'nutrition/syringes-pumps': 'Syringes & Pumps medical enteral nutrition',
    'nutrition/tube-feeding': 'Tube Feeding medical enteral nutrition',
    'nutrition/enteral-access': 'Enteral Access medical enteral nutrition',
    'nutrition/feeding-tubes': 'Feeding Tubes medical enteral nutrition',
    'nutrition/oral-hygiene': 'Oral Hygiene medical enteral nutrition',
    'nutrition/hydration': 'Hydration medical enteral nutrition',
    'nutrition/enteral-supplies': 'Enteral Supplies medical enteral nutrition',
    'nutrition/dysphagia': 'Dysphagia medical enteral nutrition',
    'nutrition/oral-nutrition': 'Oral Nutrition medical enteral nutrition',
    'nutrition/pump': 'enteral feeding pump',
    'or-surgery/sutures-staples': 'Sutures & Staples surgical operating room',
    'or-surgery/surgical-instruments': 'Surgical Instruments surgical operating room',
    'or-surgery/sutures': 'Sutures surgical operating room',
    'or-surgery/surgical-drapes': 'Surgical Drapes surgical operating room',
    'or-surgery/staples': 'Staples surgical operating room',
    'or-surgery/hemostatic-agents': 'Hemostatic Agents surgical operating room',
    'or-surgery/electrosurgery': 'Electrosurgery surgical operating room',
    'or-surgery/surgical-gowns': 'Surgical Gowns surgical operating room',
    'or-surgery/procedure-drapes': 'Procedure Drapes surgical operating room',
    'or-surgery/surgical-masks': 'Surgical Masks surgical operating room',
    'or-surgery/personal-protection': 'surgical PPE mask',
    'or-surgery/wound-cavity': 'surgical wound packing',
    'or-surgery/surgical-accessories': 'Surgical Accessories surgical operating room',
    'or-surgery/head-face': 'surgical cap face mask',
    'or-surgery/laparoscopy': 'Laparoscopy surgical operating room',
    'or-surgery/wound-closure': 'Wound Closure surgical operating room',
    'or-surgery/sponges': 'surgical gauze sponge',
    'or-surgery/gowns': 'surgical gown',
    'or-surgery/cautery': 'surgical cautery device',
    'or-surgery/retractors': 'Retractors surgical operating room',
    'orthopedic/ambulatory': 'walking aid orthopedic',
    'orthopedic/walking-aids': 'Walking Aids orthopedic brace support',
    'orthopedic/splints-braces': 'Splints & Braces orthopedic brace support',
    'orthopedic/knee': 'knee brace orthopedic',
    'orthopedic/cervical': 'cervical collar neck brace',
    'orthopedic/canes': 'Canes orthopedic brace support',
    'orthopedic/ankle': 'ankle brace orthopedic',
    'orthopedic/exercise-therapy': 'Exercise & Therapy orthopedic brace support',
    'orthopedic/casting': 'Casting orthopedic brace support',
    'orthopedic/electrotherapy': 'Electrotherapy orthopedic brace support',
    'orthopedic/back': 'back brace orthopedic',
    'orthopedic/wrist': 'wrist brace orthopedic',
    'orthopedic/elbow': 'elbow brace orthopedic',
    'orthopedic/lower-limb': 'leg brace orthopedic',
    'orthopedic/hot-cold-therapy': 'Hot & Cold Therapy orthopedic brace support',
    'orthopedic/positioning': 'patient positioning cushion',
    'orthopedic/shoulder': 'shoulder brace orthopedic',
    'ppe/chemical-ppe': 'Chemical PPE medical protective equipment',
    'ppe/radiation-ppe': 'Radiation PPE medical protective equipment',
    'ppe/respiratory': 'Respiratory medical protective equipment',
    'ppe/fluid-resistant': 'Fluid-Resistant medical protective equipment',
    'ppe/masks': 'Masks medical protective equipment',
    'ppe/bouffant-caps': 'Bouffant Caps medical protective equipment',
    'ppe/gowns': 'Gowns medical protective equipment',
    'ppe/face-shields': 'Face Shields medical protective equipment',
    'ppe/shoe-covers': 'Shoe Covers medical protective equipment',
    'ppe/surgical': 'surgical PPE mask',
    'ppe/full-body': 'full body PPE suit',
    'ppe/foot-protection': 'Foot Protection medical protective equipment',
    'ppe/head': 'PPE head cover',
    'ppe/eye': 'safety goggles PPE',
    'ppe/eye-face': 'face shield PPE',
    'patient-care/patient-care': 'hospital patient care',
    'patient-care/monitoring': 'Monitoring hospital patient care',
    'patient-care/patient-safety': 'Patient Safety hospital patient care',
    'patient-care/equipment': 'hospital patient equipment',
    'patient-care/textiles': 'Textiles hospital patient care',
    'patient-care/urinals': 'Urinals hospital patient care',
    'patient-care/bedpans': 'Bedpans hospital patient care',
    'patient-care/patient-transfer': 'Patient Transfer hospital patient care',
    'patient-care/patient-apparel': 'Patient Apparel hospital patient care',
    'patient-care/lab': 'medical lab supplies',
    'patient-care/exam': 'medical exam room',
    'patient-care/durable-medical-equipment': 'Durable Medical Equipment hospital patient care',
    'patient-care/patient-mobility': 'Patient Mobility hospital patient care',
    'patient-care/furniture': 'hospital furniture',
    'patient-care/thermometers': 'Thermometers hospital patient care',
    'patient-care/oral-care': 'Oral Care hospital patient care',
    'patient-care/blood-pressure': 'Blood Pressure hospital patient care',
    'patient-care/bathing-hygiene': 'Bathing & Hygiene hospital patient care',
    'patient-care/repositioning': 'Repositioning hospital patient care',
    'pediatric/pediatric': 'pediatric medical care',
    'pediatric/pediatric-equipment': 'Pediatric Equipment pediatric medical',
    'pediatric/infant-care': 'Infant Care pediatric medical',
    'pediatric/pediatric-supplies': 'Pediatric Supplies pediatric medical',
    'pharmacy/pharmacy': 'pharmacy medication',
    'pharmacy/medication-administration': 'Medication Administration pharmacy medication',
    'pharmacy/sharps-disposal': 'Sharps Disposal pharmacy medication',
    'pharmacy/counting-trays': 'Counting Trays pharmacy medication',
    'pharmacy/pharmacy-supplies': 'Pharmacy Supplies pharmacy medication',
    'pharmacy/pill-organizers': 'Pill Organizers pharmacy medication',
    'respiratory/suction': 'Suction respiratory oxygen medical equipment',
    'respiratory/oxygen-mask': 'Oxygen Mask respiratory oxygen medical equipment',
    'respiratory/tracheostomy-tube': 'Tracheostomy Tube respiratory oxygen medical equipment',
    'respiratory/oxygen-therapy': 'Oxygen Therapy respiratory oxygen medical equipment',
    'respiratory/tracheostomy-care': 'Tracheostomy Care respiratory oxygen medical equipment',
    'respiratory/yankauer-suction-tip': 'Yankauer Suction Tip respiratory oxygen medical equipment',
    'respiratory/peak-flow-meter': 'Peak Flow Meter respiratory oxygen medical equipment',
    'respiratory/resuscitation-bag': 'Resuscitation Bag respiratory oxygen medical equipment',
    'respiratory/nasal-cannula': 'Nasal Cannula respiratory oxygen medical equipment',
    'respiratory/spirometer': 'Spirometer respiratory oxygen medical equipment',
    'respiratory/laryngeal-mask-airway': 'Laryngeal Mask Airway respiratory oxygen medical equipment',
    'respiratory/aerosol-mask': 'Aerosol Mask respiratory oxygen medical equipment',
    'respiratory/cpap-mask': 'CPAP Mask respiratory oxygen medical equipment',
    'respiratory/nebulizers': 'Nebulizers respiratory oxygen medical equipment',
    'respiratory/bipap-mask': 'BiPAP Mask respiratory oxygen medical equipment',
    'respiratory/ventilator-circuit': 'Ventilator Circuit respiratory oxygen medical equipment',
    'respiratory/endotracheal-tube': 'Endotracheal Tube respiratory oxygen medical equipment',
    'respiratory/trachea-care-kit': 'Trachea Care Kit respiratory oxygen medical equipment',
    'respiratory/suction-catheter': 'Suction Catheter respiratory oxygen medical equipment',
    'respiratory/tracheostomy': 'tracheostomy care medical',
    'respiratory/masks-filters': 'Masks & Filters respiratory oxygen medical equipment',
    'respiratory/tracheal-suction-kit': 'Tracheal Suction Kit respiratory oxygen medical equipment',
    'respiratory/nebulizer': 'Nebulizer respiratory oxygen medical equipment',
    'respiratory/oxygen-tubing': 'Oxygen Tubing respiratory oxygen medical equipment',
    'respiratory/spirometry': 'Spirometry respiratory oxygen medical equipment',
    'respiratory/oxygen-delivery': 'Oxygen Delivery respiratory oxygen medical equipment',
    'skin-care/cleansing': 'skin cleanser medical',
    'skin-care/protective': 'skin protectant medical',
    'skin-care/moisturizers': 'Moisturizers medical skin care',
    'skin-care/antifungal': 'Antifungal medical skin care',
    'skin-care/antifungals': 'Antifungals medical skin care',
    'skin-care/cleansers': 'Cleansers medical skin care',
    'skin-care/protective-film': 'Protective Film medical skin care',
    'skin-care/moisturizing': 'medical moisturizer cream',
    'skin-care/body-wash': 'Body Wash medical skin care',
    'skin-care/pressure-relief': 'Pressure Relief medical skin care',
    'skin-care/deodorizing': 'deodorizing spray medical',
    'skin-care/adhesive-removal': 'Adhesive Removal medical skin care',
    'skin-care/barrier-creams': 'Barrier Creams medical skin care',
    'skin-care/wound-cleansers': 'Wound Cleansers medical skin care',
    'textiles/linen': 'hospital linen',
    'textiles/patient-gowns': 'Patient Gowns hospital linen textile',
    'textiles/bed-linens': 'Bed Linens hospital linen textile',
    'textiles/healthcare-apparel': 'Healthcare Apparel hospital linen textile',
    'textiles/washcloths': 'Washcloths hospital linen textile',
    'textiles/towels-washcloths': 'Towels & Washcloths hospital linen textile',
    'textiles/draw-sheets': 'Draw Sheets hospital linen textile',
    'textiles/blankets': 'Blankets hospital linen textile',
    'textiles/launderable-gowns': 'Launderable Gowns hospital linen textile',
    'textiles/draping': 'surgical drape',
    'textiles/patient-apparel': 'Patient Apparel hospital linen textile',
    'textiles/apparel': 'healthcare apparel scrubs',
    'textiles/gowns': 'patient gown hospital',
    'ostomy/urinary-drainage': 'Urinary Drainage urology ostomy medical',
    'ostomy/ostomy': 'ostomy supplies medical',
    'ostomy/urinary': 'urinary catheter medical',
    'ostomy/ostomy-accessories': 'Ostomy Accessories urology ostomy medical',
    'ostomy/intermittent-catheters': 'Intermittent Catheters urology ostomy medical',
    'ostomy/foley-catheters': 'Foley Catheters urology ostomy medical',
    'ostomy/ostomy-pouches': 'Ostomy Pouches urology ostomy medical',
    'ostomy/monitoring': 'urine output monitoring medical',
    'ostomy/urinary-catheters': 'Urinary Catheters urology ostomy medical',
    'ostomy/drainage-bags': 'Drainage Bags urology ostomy medical',
    'wound-care/skin-protectants': 'Skin Protectants wound care dressing medical',
    'wound-care/negative-pressure-npwt': 'Negative Pressure (NPWT) wound care dressing medical',
    'wound-care/wound-cleansers': 'Wound Cleansers wound care dressing medical',
    'wound-care/collagen-dressings': 'Collagen Dressings wound care dressing medical',
    'wound-care/hydrocolloid-dressings': 'Hydrocolloid Dressings wound care dressing medical',
    'wound-care/gauze-sponges': 'Gauze Sponges wound care dressing medical',
    'wound-care/alginate-dressings': 'Alginate Dressings wound care dressing medical',
    'wound-care/hydrogel-dressings': 'Hydrogel Dressings wound care dressing medical',
    'wound-care/abd-pads': 'ABD Pads wound care dressing medical',
    'wound-care/island-dressings': 'Island Dressings wound care dressing medical',
    'wound-care/silver-antimicrobial': 'Silver Antimicrobial wound care dressing medical',
    'wound-care/transparent-film': 'Transparent Film wound care dressing medical',
    'wound-care/wound-closure-strips': 'Wound Closure Strips wound care dressing medical',
    'wound-care/compression-bandages': 'Compression Bandages wound care dressing medical',
    'wound-care/foam-dressings': 'Foam Dressings wound care dressing medical',
    'wound-care/compression': 'compression bandage wound',
    'wound-care/tapes-adhesives': 'Tapes & Adhesives wound care dressing medical',
    'wound-care/bandages': 'Bandages wound care dressing medical',
    'wound-care/gauze': 'Gauze wound care dressing medical',
    'wound-care/dressings': 'wound dressing medical',
    'wound-care/wound-closure': 'wound closure strips medical',
    'wound-care/antimicrobial-dressings': 'Antimicrobial Dressings wound care dressing medical',
    'wound-care/wound-dressings': 'Wound Dressings wound care dressing medical',
}
...
def category_photo(cat_slug, n):
    """Legacy 2-segment route — kept for any cached/bookmarked URLs. Delegates
    to the subcategory-aware handler with an empty subcategory bucket."""
    return _serve_bucket_photo(cat_slug, "_", n)

@app.route("/api/photo/<cat_slug>/<subcat_slug>/<int:n>")
def subcategory_photo(cat_slug, subcat_slug, n):
    return _serve_bucket_photo(cat_slug, subcat_slug, n)

def _serve_bucket_photo(cat_slug, subcat_slug, n):
    bucket = f"{cat_slug}/{subcat_slug}" if subcat_slug and subcat_slug != "_" else cat_slug
    if bucket not in _PEXELS_CACHE:
        query = (SUBCAT_PEXELS_QUERIES.get(bucket)
                  or PEXELS_QUERIES.get(cat_slug)
                  or "medical supplies")
        _PEXELS_CACHE[bucket] = _fetch_pexels_photos(query)
    photos = _PEXELS_CACHE.get(bucket, [])
    if not photos and bucket != cat_slug:
        # Subcategory pool came back empty (e.g. API hiccup) — fall back to
        # the broader category pool rather than dropping straight to an icon.
        if cat_slug not in _PEXELS_CACHE:
            _PEXELS_CACHE[cat_slug] = _fetch_pexels_photos(PEXELS_QUERIES.get(cat_slug, "medical supplies"))
